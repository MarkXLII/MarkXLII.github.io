...
function drawCharts() {
    ...
    drawChart(document.getElementById('chart_div_2'), 'B5:B,D5:D', 'INDIA', series_2)
    drawChart(document.getElementById('chart_div_3'), 'B5:B,E5:E', 'INDIA', series_1)
    ...
    drawChart(document.getElementById('chart_div_6'), 'B5:B,D5:D', 'USA', series_2)
    drawChart(document.getElementById('chart_div_7'), 'B5:B,E5:E', 'USA', series_1)
