...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // If you are testing HTML files locally (file://...) and your server is on localhost,
    // this will work. For GitHub Pages, it MUST be your publicly accessible server URL.
